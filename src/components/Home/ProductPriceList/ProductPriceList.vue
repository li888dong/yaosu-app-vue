...
<template>
    ...
    <div id="price" class="product-container pannel">
        ...
        <div class="product-price" @click="gotoPriceList">
...
//            切换显示的原料药和中药材
            ...
            gotoPriceList(e) {
                if (this.show === 'yuanliao'){
                    this.$router.push({path: 'yuanliao_price', query: {type: '原料药'}})
                }else {
                    this.$router.push({path: 'zhongyao_price', query: {type: '中药'}})
                }
            }
        },
        beforeDestroy(){
